...
const treatmentPreviews = [
  {
    title: "שם טיפול מובחר",
    description: "טקסט דמה המתאר את הטיפול המקצועי, היתרונות שלו והתוצאה המצופה למען המחשת העיצוב.",
      ...
      <div className="container px-4 mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-primary tracking-tight uppercase-hebrew">הטיפולים הנבחרים שלנו</h2>
