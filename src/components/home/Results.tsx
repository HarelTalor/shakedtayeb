  ...
  const results = [
    {
      ...
      desc: "[טקסט דמה המתאר את תוצאות הטיפול והשינוי שהושג]"
    },
    {
      before: "/images/result_lips_before.png",
      after: "/images/result_lips_after.png",
      title: "שם טיפול מובחר",
      desc: "[טקסט דמה המתאר את תוצאות הטיפול והשינוי שהושג]"
    },
    {
          ...
          {results.map((result, index) => (
            ...
            >
              ...
              <div className="space-y-1 text-center">
                <h3 className="text-lg md:text-xl font-bold text-primary">{result.title}</h3>
